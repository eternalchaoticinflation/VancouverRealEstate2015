...
public class AssignStreet extends Application {
			...
			////
			//#6
			public List<String> streetnamegrouplist = new ArrayList<>(Arrays.asList());
			public List<Integer> numOfhouseperstreet = new ArrayList<>(Arrays.asList());
			public List<Double> currentmeanperstreet = new ArrayList<>(Arrays.asList());
			public List<Double> currentSDperstreet = new ArrayList<>(Arrays.asList());
			public List<Double>  houseAgeperstreet = new ArrayList<>(Arrays.asList());
			public List<Double>  houseAgeSDperstreet = new ArrayList<>(Arrays.asList());
			public List<Double>  plvmeanperstreet = new ArrayList<>(Arrays.asList());
		...
		{	VBox root = new VBox();		
			...
			//readCSVFile
			readcleanzonecatCSVFile("C:/School/Sem3/BusinessInt/property_tax_report_csv2015/cleansortedZAstreetname.csv");
		...
		public void readcleanzonecatCSVFile(String filename)
		{
			...
			try(BufferedReader reader = Files.newBufferedReader(Paths.get(filename)))
			{
				...
				Double srtlandValue;String streetnameread="";String streetnamegroup="YUKON ST";	int numofProbySrt=0;
				///////////
				//#2
				...
				for (int s=0;s<10;s++){		
				 ...
				 System.out.println("meanperstreet first10 "+ meanperstreet.get(s));
				 System.out.println("sDperstreet first10 "+ sDperstreet.get(s));
				 System.out.println("housemeanperstreet.gethouseAgeMean() first10 "+ housemeanperstreet.get(s));
				 System.out.println("housesDperstreet.gethouseAgeSD() "+ housesDperstreet.get(s));
				 System.out.println("pmeanperstreet "+  pmeanperstreet.get(s));
				 System.out.println("diff is (meanperstreet-pmeanperstreet)*numhouseperstreet "+  numhouseperstreet.get(s)*(meanperstreet.get(s)-pmeanperstreet.get(s)));
				...
				streetnamegrouplist=streetgrouplist;
				numOfhouseperstreet=numhouseperstreet; 
				currentmeanperstreet=meanperstreet;
				currentSDperstreet=sDperstreet; 
				houseAgeperstreet=housemeanperstreet;
				houseAgeSDperstreet=housesDperstreet;
				plvmeanperstreet=pmeanperstreet;
